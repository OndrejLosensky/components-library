    ...
    <div className="prose prose-gray max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          Accordions are used to organize and show/hide content in a collapsible manner.
        </p>
        ...
        <div className="p-6 bg-white rounded-lg border border-gray-200">
          <Accordion>
            ...
            <AccordionItem title="How does it work?">
              <p>Click the header to expand/collapse the content. Only one section can be open at a time by default.</p>
            </AccordionItem>
            <AccordionItem title="Can I customize it?">
              <p>Yes! The accordion supports different variants, sizes, and can be styled using custom classes.</p>
            </AccordionItem>
          </Accordion>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="p-6 bg-white rounded-lg border border-gray-200">
          <Accordion>
            ...
            <AccordionItem 
              title="Labs" 
              icon={<IoFlask className="w-5 h-5" />}
            >
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-4">
          Accordions can be configured to allow multiple items to be open simultaneously.
        </p>
